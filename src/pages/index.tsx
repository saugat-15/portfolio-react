        ...
        <section className="">
          ...
          <div className="text-center p-10 py-10">
            ...
            <div className="text-5xl flex justify-center gap-10 py-3 text-gray-600 dark:text-gray-400">
              ...
              <Link
                href="https://www.linkedin.com/in/saugat-giri-66011513b/"
                target="_blank"
              >
                <AiFillLinkedin className="hover:text-teal-600" />
              </Link>
              <Link
                href="https://www.instagram.com/saugat_giri/"
                target="_blank"
              >
            ...
            {/* <div className="mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 relative overflow-hidden mt-20 md:h-96 md:w-96">
              <Image alt="" src={profile} layout="fill" objectFit="cover" />
            </div> */}
          </div>
        </section>
        <section>
        ...
        <section className="py-10">
          ...
          <div className="flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap">
            ...
            <div className="basis-1/3 flex-1">
              ...
              <Link
                href="https://projectedgeledger.netlify.app/#home"
                target="_blank"
              >
                <Image
                  alt=""
